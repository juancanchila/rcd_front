...
export class GeneradorForm implements OnInit {
  ...
  constructor(
    ...
    this.vehiculodocuments = this.fb.group({
      ...
      autorizacion_bic: [''], // solo si aplica BIC
      registro_defuncion: [''], // solo si aplica Persona Natural fallecido
    });
  ...
  onSubmit(): void {
    ...
    this.toast.showSuccess('Vehículo guardado correctamente', '/lista/transportador/');
  }
}
